...
class Cli
{
    ...
    {
        //stop
        pcntl_signal(SIGINT,  array('self', 'signalHandler'), false);
        //status
        pcntl_signal(SIGUSR2, array('self', 'signalHandler'), false);
        //reload
        pcntl_signal(SIGHUP, array('self', 'signalHandler'), false);
